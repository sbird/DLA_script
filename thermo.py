...
plt.plot(tau_ar512[:,0], tau_ar512[:,1] ,color="blue",ls="-")
plt.plot(tau_gad512[:,0],tau_gad512[:,1],color="red",ls="--")
plt.plot(tau_ar256[:,0], tau_ar256[:,1] ,color="blue",ls=":")
plt.plot(tau_gad256[:,0],tau_gad256[:,1],color="red",ls="-.")
plt.ylabel(r"$\tau_\mathrm{eff}$")
plt.yticks((0,0.4,0.8,1.2,1.6),('0','0.4','0.8','1.2','1.6'))
plt.ylim(0,1.6)
ax2=plt.subplot(gs[1],sharex=ax1)
# plt.ylabel("Flux PDF")
plt.plot(tau_ar512[:,0], 100*(tau_ar512[:,1]/tau_gad512[:,1]-1) ,color="blue",ls="-")
plt.plot(tau_ar256[:,0], 100*(tau_ar256[:,1]/tau_gad512[:,1]-1) ,color="blue",ls=":")
plt.plot(tau_gad256[:,0],100*(tau_gad256[:,1]/tau_gad512[:,1]-1),color="red",ls="-.")
...
pflux.pdfrelplots(159,color="green")
pflux.pdfrelplots(189,color="red")
# plt.ylabel("Flux PDF")
plt.ylim(-8,8)
...
gs = gridspec.GridSpec(2, 1, height_ratios=[3, 1])
ax1=plt.subplot(gs[0])
pflux.pfplots(119,color="black")
pflux.pfplots(139)
pflux.pfplots(159,color="green")
pflux.pfplots(189,color="red")
plt.ylim(2e-2,0.5)
plt.yticks((0.1,0.5),('0.1','0.5'))
ax2=plt.subplot(gs[1],sharex=ax1)
pflux.pfrelplots(119,color="black")
pflux.pfrelplots(139)
pflux.pfrelplots(159,color="green")
pflux.pfrelplots(189,color="red")
plt.ylim(-6,6)
plt.yticks((-5,0,5),('-5','0','5'))
plt.subplots_adjust(hspace=0)
plt.setp( ax1.get_xticklabels(), visible=False)
