...
plt.plot(tau_ar512[:,0], tau_ar512[:,1] ,color="red",ls="-")
plt.plot(tau_gad512[:,0],tau_gad512[:,1],color="blue",ls="--")
plt.plot(tau_ar256[:,0], tau_ar256[:,1] ,color="red",ls=":")
plt.plot(tau_gad256[:,0],tau_gad256[:,1],color="blue",ls="-.")
plt.ylabel(r"$\tau_\mathrm{eff}$")
plt.yticks((0,0.4,0.8,1.2,1.6),('0','0.4','0.8','1.2','1.6'))
plt.ylim(0,1.6)
ax2=plt.subplot(gs[1],sharex=ax1)
# plt.ylabel("Flux PDF")
plt.plot(tau_ar512[:,0], 100*(tau_ar512[:,1]/tau_gad512[:,1]-1) ,color="red",ls="-")
plt.plot(tau_ar256[:,0], 100*(tau_ar256[:,1]/tau_gad512[:,1]-1) ,color="red",ls=":")
plt.plot(tau_gad256[:,0],100*(tau_gad256[:,1]/tau_gad512[:,1]-1),color="blue",ls="-.")
